...
async def add_admin_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # Jika tidak ada reply dan tidak ada argumen
    else:
        await message.reply_text(
            "❌ <b>Format salah!</b>\n\n"
            "Gunakan:\n"
    ...
    # Cegah Owner menambahkan dirinya sendiri sebagai admin (redundan)
    from config import config
    if user_id == config.OWNER_ID:
        await message.reply_text(
            "⚠️ Anda adalah Owner bot, tidak perlu ditambahkan sebagai admin.",
            parse_mode='HTML'
        )
        return
...
# Fungsi untuk mendaftarkan semua handler admin ke aplikasi
